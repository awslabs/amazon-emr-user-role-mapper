...
public class TestConstants {
    public static final int UNKNOWN_USERNAME_UID = 1000;
    public static final String EMPTY_ROLE_NAME = "";
    public static final String EMPTY_ROLE_CREDENTIALS = "";
    public static final int USER1_UID = 503;
