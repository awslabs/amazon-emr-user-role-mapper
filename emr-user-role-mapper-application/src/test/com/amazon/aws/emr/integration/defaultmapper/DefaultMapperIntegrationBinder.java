...
import com.amazon.aws.emr.integration.IntegrationTestsPrincipalResolver;
import com.amazon.aws.emr.integration.IntegrationTestsUserService;
import com.amazon.aws.emr.integration.defaultmapper.DefaultMapperImplApplicationConfig;
...
public class DefaultMapperIntegrationBinder extends AbstractBinder {
    ...
    protected void configure() {
        ...
        bind(DefaultMapperImplApplicationConfig.class).to(ApplicationConfiguration.class).in(Immediate.class);
        bind(IntegrationTestsPrincipalResolver.class).to(PrincipalResolver.class).in(Singleton.class);
    }
}
